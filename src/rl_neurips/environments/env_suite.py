    ...
    def _get_environment_configs(self) -> Dict[str, Dict]:
        ...
        configs = {
            ...
            'MountainCar-v0': {
                ...
                'max_steps': 200,
                'reward_scale': 1.0,
                'target_reward': -110,  # Success threshold (reach flag)
                'description': 'Reach mountain peak using discrete actions, sparse reward'
            },
            ...
            'LunarLander-v3': {
                ...
                'max_steps': 1000,
                'reward_scale': 1.0,
                'target_reward': 200,  # Success threshold
                'description': 'Land spacecraft with discrete thrusters, complex dynamics'
            },
            'BipedalWalker-v3': {
                ...
                'max_steps': 1600,
                'reward_scale': 1.0,
                'target_reward': 300,  # Success threshold
                'description': 'Bipedal robot locomotion with continuous control'
            },
            'HalfCheetah-v4': {
